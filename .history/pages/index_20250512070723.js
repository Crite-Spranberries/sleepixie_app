  ...
  return (
    <div className="mainContainer">
      ...
      <div>
        ...
        <Image src="/icons/InactiveSupProg.svg" alt="supplementProgress" />
        <Image src="/icons/InactiveWaterProg.svg" alt="waterProgress" />
        <Image src="/icons/GoalAdd.svg" alt="goalAdd" />
      </div>
